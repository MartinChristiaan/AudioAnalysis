...
//     constructor({time,frequency,isBuildup}:Onset,color : rgb) {
//         this.onsetTime = time;   
//         this.state= NoteState.ALIVE
//         this.y = innerHeight;
//         this.TrailParticles = []
//         this.color = color // noteColorer.getNoteColorRaw(this.t)
//         this.livetimeAfterDead = 20
//         this.orbitParticles = []
//         this.isBuildUp = isBuildup // not e idx not onset idx
//     }
...
//     // }
//     update() {
//             var percentTravelled = (this.onsetTime - this.song.t_min) / (this.song.t_max - this.song.t_min);
