...
class ScoreDrawer {
    constructor(ctx, scoremanager, song) {
        this.ctx = ctx;
        this.song = song;
    ...
    drawProgressBar(value, low, high, xpos, ypos, maxWidth, maxHeight, fontsize) {
    ...
    drawScore() {
        ...
        this.drawProgressBar(this.scoreManager.score, this.scoreManager.level * 10, this.scoreManager.level * 10 + 10, 150, 100, 200, 25, 20);
...
function addRandomDeviation(color, dev = 20) {
...
class HitDetection {
    ...
    detectHits() {
        this.song.visibleIdx.forEach(idx => {
            var t_min = this.song.t_onset[idx] - config_1.margin;
            var t_max = this.song.t_onset[idx] + config_1.margin;
            if (this.noteStates[idx] == exports.noteStates.DEAD) {
                this.noteStates[idx] = exports.noteStates.ALIVE;
            }
            if (this.noteStates[idx] == exports.noteStates.ALIVE) {
                if (this.song.t_cur > t_min && this.song.t_cur < t_max) {
                    ...
                    if (this.activeNotes[noteIdx] > 0) { // right button hit
                        this.noteStates[idx] = exports.noteStates.HIT; // hit
                 ...
                 {
                    this.noteStates[idx] = exports.noteStates.MISS; // miss
...
class InstrumentDrawer {
    constructor(song, ctx, colorizer) {
        this.song = song;
        this.ctx = ctx;
        this.noteColoror = colorizer;
    }
    update(ActiveNotes, { numNotes }) {
        var song = this.song;
        var ctx = this.ctx;
...
},{"./postprocessing":13}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.loadSongData = loadSongData;
},{}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const song_1 = require("./song");
const dynamicsManager_1 = require("./dynamicsManager");
const hitDetection_1 = require("./hitDetection");
const noteDrawer_1 = require("./noteDrawer");
const instrumentDrawer_1 = require("./instrumentDrawer");
const ScoreDrawer_1 = require("./ScoreDrawer");
const colors_1 = require("./colors");
const postprocessing_1 = require("./postprocessing");
const loader_1 = require("./loader");
const gearmanager_1 = require("./gearmanager");
// canvas setup
...
// custom setup
let songdata = loader_1.loadSongData();
let song = new song_1.Song(songdata);
...
let gearbox = new gearmanager_1.GearBox(songdata);
// start with song
...
// Add boosters
// Special notes 
},{"./ScoreDrawer":2,"./colors":3,"./dynamicsManager":5,"./gearmanager":6,"./hitDetection":7,"./instrumentDrawer":8,"./loader":9,"./noteDrawer":11,"./postprocessing":13,"./song":15}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const noteParticle_1 = require("./noteParticle");
class NoteDrawer {
    constructor(gear, ctx, colorer) {
        this.notePartles = [];
        gear.t_onset.forEach((time, idx, x) => {
            this.notePartles.push(new noteParticle_1.NoteParticle(gear, idx, ctx, colorer));
        });
    }
    update(noteStates) {
...
},{"./noteParticle":12}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const hitDetection_1 = require("./hitDetection");
const config_1 = require("./config");
...
class OrbitParticle {
    constructor(r, angle, y, x, size, color) {
        this.r = r;
        this.angle = angle;
        this.y = y;
        this.x = x;
...
class NoteParticle {
    constructor({ f_onset, t_onset, numNotes }, idx, ctx, noteColorer) {
    ...
    update(state) {
        if (state != hitDetection_1.noteStates.DEAD) {
            ...
            if (this.orbitParticles.length == 0) {
                this.orbitParticles = Array.from({ length: config_1.orbitParticles }, (_, id) => {
                    return new OrbitParticle(10, id * Math.PI * 2 / config_1.orbitParticles, this.y, this.x, 3, colors_1.addRandomDeviation(this.color, 100));
                });
            }
...
},{"./colors":3,"./config":4,"./hitDetection":7,"./main":10,"./postprocessing":13}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const screenshake_1 = require("./screenshake");
const main_1 = require("./main");
...
},{"./main":10,"./screenshake":14}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class ScreenShaker {
    constructor() {
...
class Song {
    ...
    update(speed) {
        ...
        this.delta = 2 / (speed * config_1.dt + 1);
...
exports.Song = Song;
},{"./config":4,"howler":1}]},{},[10])
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
