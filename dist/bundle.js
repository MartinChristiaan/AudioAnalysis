...
exports.SelectedSong = SelectedSong;
function selectSong(idx = -1, onSongSelected, onSongDataLoaded) {
    ...
    let loadSongData = (duration) => {
        ...
        const songdata = new SongData(data[0], data[1], data[2], data[3], data[4], duration);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const MyEvent_1 = require("./util/MyEvent");
const songplayer_1 = require("./songplayer");
...
exports.canvas.width = document.getElementById("canvasdiv").clientWidth;
exports.ctx = exports.canvas.getContext('2d');
let onSongSelected = new MyEvent_1.MyEvent();
let onSongStarted = new MyEvent_1.MyEvent();
let onSongDataLoaded = new MyEvent_1.MyEvent();
onSongStarted.subscribe((x) => console.log("Started"));
onSongDataLoaded.subscribe((x) => console.log(x.onsets));
onSongSelected.subscribe((x) => {
    onSongStarted.subscribe((sound) => x.loadSongData(sound));
    songplayer_1.loadSong(x.source, onSongStarted);
});
loader_1.selectSong(1, onSongSelected, onSongDataLoaded);
function main() {
...
},{"./loader":2,"./songplayer":4,"./util/MyEvent":5}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function loadSong(source, onSongStarted) {
...
},{"howler":1}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
